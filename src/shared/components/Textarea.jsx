/**
 * Textarea
 * @param {{ label?: string } & React.TextareaHTMLAttributes} props
 */
export default function Textarea({ label, style: extraStyle, labelStyle, focusBorderColor = "#00d4ff", blurBorderColor = "#2a3040", ...rest }) {
  return (
